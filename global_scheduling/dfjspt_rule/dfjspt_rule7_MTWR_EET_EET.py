...
from DFJSPT_generalize.dfjspt_rule.job_selection_rules import job_MTWR_action
from DFJSPT_generalize.dfjspt_rule.machine_selection_rules import machine_EET_action, transbot_EET_action
...
if __name__ == '__main__':
    ...
    # # makespan = rule7_single_makespan(
