...
class InitialScheduleEnv(MultiAgentEnv):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.time_upper_bound = self.initial_estimated_makespan * 10
            ...
            for operation_id in local_schedule_job.operations:
                ...
                if local_schedule_job_operation.assigned_transbot is not None:
                    scheduled_transporting_op = (job_id, operation_id,
                                               local_schedule_job.operations[operation_id].scheduled_start_transporting_time)
                    if operation_id == 0:
                        ...
                        if local_schedule_job.operations[operation_id].assigned_machine != local_schedule_job.operations[operation_id - 1].assigned_machine:
                            op_index = bisect.bisect_left([op[2] for op in self.factory_instance.agv[
                                local_schedule_job_operation.assigned_transbot
                            ].transport_tasks_queue_for_current_time_window],
    ...
    def step(self, action_dict):
        ...
        if self.all_agents_have_made_decisions:
            ...
            # if self.current_time_after_step > 900:
